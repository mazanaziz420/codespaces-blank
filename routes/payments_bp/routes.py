...
@payments_bp.route('/all_payments', methods=['GET'])
@jwt_required()
...
@payments_bp.route('/payment_by_user_id', methods=['GET'])
@jwt_required()
...
@payments_bp.route('/payment_by_stripe_id/<stripe_payment_id>', methods=['GET'])
@jwt_required()
...
@payments_bp.route('/payment_by_status/<status>', methods=['GET'])
@jwt_required()
